...
export function IconCard({ icon, title, desc, color, layout = "vertical", align = "left", __editable, __onPropsChange }: IconCardProps) {
  ...
  return (
    <div className={`glass-panel flex flex-col gap-3 ${alignClass}`}>
      {Icon && (
